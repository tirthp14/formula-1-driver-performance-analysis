...
const Home = () => {
    return (
        <div className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen flex flex-col justify-between">
        {/* Hero Section */}
        <section className="bg-gradient-to-b from-gray-950 to-gray-900 h-screen-minus-92 flex flex-col justify-center items-center text-center px-6 py-12 md:px-12">
            ...
            >
                <a
                    href="#features"
                    className="bg-red-700 text-white px-6 py-3 rounded-full font-semibold flex items-center hover:bg-red-600 transition"
                    >
            ...
            <div>
                <div className="flex gap-x-16">
                    <div className="w-1/2 py-10">
                        <img src={require("../assets/Home Page/Image 1.png")} />
                    </div>
                    <div className="relative last:after:hidden after:absolute after:top-9 after:bottom-2 after:start-3.5 after:w-[2px] after:-translate-x-[0.5px] after:bg-neutral-200">
                    ...
                    {/* Description */}
                    <div className="py-10 w-1/2 grow">
                        <p className="text-xl font-light leading-relaxed text-gray-200 bg-[#ffffff] bg-opacity-5 backdrop-blur-sm drop-shadow-md p-6 rounded-2xl shadow-2xl">
                            <span className="text-2xl font-semibold block mb-4 text-center">Dive into the excitement of Formula 1 qualifying!</span>
                            Explore our <span className="font-bold">Qualifying Analysis</span> to uncover key moments of race weekends:
                            <div className="mt-6 flex space-x-4">
                                <div className="flex-1 bg-[#ffffff] bg-opacity-10 p-4 rounded-lg shadow-md text-gray-300">
                                    Review top drivers' performances from recent seasons and Grand Prix locations.
                                </div>
                                <div className="flex-1 bg-[#ffffff] bg-opacity-10 p-4 rounded-lg shadow-md text-gray-300">
                                    Analyze sector times, lap consistency, and car performance with detailed visuals.
                                </div>
                                <div className="flex-1 bg-[#ffffff] bg-opacity-10 p-4 rounded-lg shadow-md text-gray-300">
                                    See how drivers push limits to achieve the best grid positions.
                                </div>
                            </div>
                        </p>
                    </div>
                ...
                <div className="flex gap-x-16">
                    ...
                    <div className="py-10 w-1/2 grow">
                        <p className="text-xl font-light leading-relaxed text-gray-200 bg-[#ffffff] bg-opacity-5 backdrop-blur-sm drop-shadow-md p-6 rounded-2xl shadow-2xl">
                            <span className="text-2xl font-semibold block mb-4 text-center">Welcome to the thrilling world of Formula 1 Race Analysis!</span>
                            Our <span className="font-bold">RaceAnalysis</span> page offers deep insights into every Grand Prix, letting you explore:
                            <div className="mt-6 space-y-6">
                                <div>
                                    <h3 className="text-xl font-semibold text-gray-300">Lap-by-lap Analysis</h3>
                                    <p className="text-gray-300">Visualize driver performance, track progress, and key race moments with detailed lap-by-lap breakdowns.</p>
                                </div>
                                <div>
                                    <h3 className="text-xl font-semibold text-gray-300">Tyre Strategies</h3>
                                    <p className="text-gray-300">Discover how teams manage tyres to gain a competitive edge, with insights into their strategic decisions.</p>
                                </div>
                                <div>
                                    <h3 className="text-xl font-semibold text-gray-300">Fastest Laps & Pit Stops</h3>
                                    <p className="text-gray-300">Track the moments when drivers pushed their limits and teams executed perfect pit stops for optimal performance.</p>
                                </div>
                                <div>
                                    <h3 className="text-xl font-semibold text-gray-300">Driver Comparisons</h3>
                                    <p className="text-gray-300">See how drivers stack up from race starts to podium finishes with comprehensive comparison data.</p>
                                </div>
                            </div>
                        </p>
                    </div>
                    <div className="relative last:after:hidden after:absolute after:top-9 after:bottom-2 after:start-3.5 after:w-[2px] after:-translate-x-[0.5px] after:bg-neutral-200">
                        ...
                        <img className="" src={require("../assets/Home Page/Image 2.png")} />
                    </div>
                </div>

                <div className="flex gap-x-16">
                    <div className="w-1/2">
                        <img src={require("../assets/Home Page/Image 3.png")} />
                    </div>
                    <div className="relative last:after:hidden after:absolute after:top-9 after:bottom-2 after:start-3.5 after:w-[2px] after:-translate-x-[0.5px] after:bg-neutral-200">
                        <div className="relative z-10 size-7 flex justify-center items-center">
                    ...
                    <div className="py-10 w-1/2 grow">
                        <p className="text-xl font-light leading-relaxed text-gray-200 bg-[#ffffff] bg-opacity-5 backdrop-blur-sm drop-shadow-md p-6 rounded-2xl shadow-2xl">
                            <span className="text-2xl font-semibold block mb-4 text-center">Introducing the <span className="font-bold">TyreStrategy</span></span>
                            A powerful tool for F1 enthusiasts, analysts, and data-driven fans alike. With this feature, you can:
                            <div className="mt-6 space-y-4">
                                <div className="text-gray-300">
                                    <p className="font-bold">Visualize Tyre Compounds:</p>
                                    See how each driver managed their tyres, switching between soft, medium, hard, intermediates, or wet compounds during the race.
                                </div>
                                <div className="text-gray-300">
                                    <p className="font-bold">Track Stint Performance:</p>
                                    Explore the crucial moments when tyre choices influenced lap times and race outcomes.
                                </div>
                                <div className="text-gray-300">
                                    <p className="font-bold">Analyze Pit Stop Strategies:</p>
                                    Dive into the timing of pit stops and how teams made tactical decisions to gain an edge on the track.
                                </div>
                            </div>
                        </p>
                    </div>
                ...
                <div className="flex gap-x-16">
                    ...
                    <div className="py-10 w-1/2 grow">
                        <p className="text-xl font-light leading-relaxed text-gray-200 bg-[#ffffff] bg-opacity-5 backdrop-blur-sm drop-shadow-md p-6 rounded-2xl shadow-2xl">
                            <span className="text-2xl font-semibold block mb-4 text-center">Explore the dynamic world of Formula 1 lap data!</span>
                            The <span className="font-bold">LapData</span> feature offers a dynamic and interactive way to explore the real-time performance of Formula 1 drivers, displaying detailed lap-by-lap insights. This tool is essential for F1 fans, analysts, and enthusiasts looking to break down race data. With LapData, you can:
                            <div className="mt-6">
                                <p className="text-gray-300"><span className="font-bold">Analyze Lap Times:</span> Visualize how each driver performed throughout the race, with detailed comparisons across multiple laps.</p>
                                <p className="text-gray-300"><span className="font-bold">Interactive Charts:</span> View lap data through a customizable and responsive line chart that highlights individual drivers' performance.</p>
                                <p className="text-gray-300"><span className="font-bold">Driver-Specific Details:</span> Easily toggle between different drivers to examine their lap strategies and pit stop timings, with personalized colors for quick identification.</p>
                                <p className="text-gray-300"><span className="font-bold">Custom Tooltips:</span> Get instant data insights by hovering over the chart to reveal lap times in a clean, readable format.</p>
                            </div>
                        </p>
                    </div>
                    <div className="relative last:after:hidden after:absolute after:top-9 after:bottom-0 after:start-3.5 after:w-[2px] after:-translate-x-[0.5px] after:bg-neutral-200">
                        <div className="relative z-10 size-7 flex justify-center items-center">
                                <svg fill="white" enable-background="new 0 0 32 32" height="32px" id="Layer_1" version="1.1" viewBox="0 0 32 32" width="32px"><g id="time_management_1_"><g><circle cx="19.252" cy="10.146" r="0.499"/><path d="M12.286,25.663c0.104-0.256,0.397-0.377,0.653-0.271c0.253,0.103,0.376,0.397,0.27,0.653 c-0.105,0.254-0.398,0.376-0.652,0.269C12.303,26.209,12.18,25.916,12.286,25.663z"/><circle cx="22.01" cy="11.989" r="0.499"/><circle cx="9.99" cy="24.011" r="0.499"/><circle cx="23.853" cy="14.747" r="0.499"/><circle cx="8.147" cy="21.253" r="0.499"/><circle cx="24.5" cy="18" r="0.5"/><circle cx="7.5" cy="18" r="0.5"/><circle cx="23.854" cy="21.252" r="0.5"/><circle cx="8.146" cy="14.748" r="0.5"/><circle cx="22.011" cy="24.01" r="0.5"/><circle cx="9.989" cy="11.99" r="0.5"/><circle cx="19.253" cy="25.853" r="0.5"/><circle cx="12.747" cy="10.147" r="0.5"/><circle cx="16" cy="26.5" r="0.5"/><circle cx="16" cy="9.5" r="0.5"/></g><path d="M16,17.5c-0.276,0-0.5-0.224-0.5-0.5v-6c0-0.276,0.224-0.5,0.5-0.5s0.5,0.224,0.5,0.5v6 C16.5,17.276,16.276,17.5,16,17.5z"/><path d="M16,19.5c-0.827,0-1.5-0.673-1.5-1.5s0.673-1.5,1.5-1.5s1.5,0.673,1.5,1.5S16.827,19.5,16,19.5z M16,17.5 c-0.276,0-0.5,0.225-0.5,0.5s0.224,0.5,0.5,0.5s0.5-0.225,0.5-0.5S16.276,17.5,16,17.5z"/><path d="M23.347,8.387c-0.102,0-0.205-0.031-0.293-0.096c-0.223-0.162-0.273-0.475-0.11-0.698l1.175-1.617 c0.161-0.224,0.474-0.273,0.698-0.11c0.223,0.162,0.273,0.475,0.11,0.698l-1.175,1.617C23.654,8.315,23.502,8.387,23.347,8.387 z"/><path d="M8.653,8.388c-0.155,0-0.307-0.071-0.405-0.206L7.073,6.563C6.911,6.34,6.96,6.027,7.184,5.865 c0.225-0.162,0.537-0.113,0.699,0.11l1.175,1.618C9.219,7.817,9.169,8.13,8.946,8.292C8.857,8.356,8.754,8.388,8.653,8.388z"/><path d="M16.5,6C16.224,6,16,5.776,16,5.5v-2C16,3.224,16.224,3,16.5,3S17,3.224,17,3.5v2 C17,5.776,16.776,6,16.5,6z"/><path d="M16,31C8.832,31,3,25.168,3,18c0-3.343,1.267-6.52,3.566-8.945c0.19-0.2,0.506-0.207,0.707-0.02 c0.201,0.19,0.209,0.507,0.019,0.707C5.169,11.982,4,14.915,4,18c0,6.617,5.383,12,12,12s12-5.383,12-12 c0-3.821-1.76-7.327-4.828-9.621c-0.221-0.165-0.267-0.479-0.101-0.7c0.166-0.221,0.479-0.267,0.7-0.101 C27.094,10.063,29,13.86,29,18C29,25.168,23.168,31,16,31z"/>
                                    <path d="M8.652,8.387c-0.155,0-0.307-0.071-0.405-0.206c-0.163-0.223-0.113-0.536,0.11-0.698 C10.59,5.858,13.232,5,16,5c2.017,0,3.951,0.449,5.747,1.336c0.248,0.122,0.35,0.422,0.227,0.67 c-0.121,0.247-0.42,0.35-0.669,0.227C19.647,6.415,17.862,6,16,6c-2.555,0-4.994,0.792-7.055,2.291 C8.857,8.355,8.754,8.387,8.652,8.387z"/>
                                    <path d="M16,29C9.935,29,5,24.065,5,18S9.935,7,16,7s11,4.935,11,11S22.065,29,16,29z M16,8 C10.486,8,6,12.486,6,18s4.486,10,10,10s10-4.486,10-10S21.514,8,16,8z"/>
                    ...
                    <div className="w-1/2 grow pt-0.5 pb-8">
                        <img src={require("../assets/Home Page/Image 4.png")} />
                    </div>
                </div>
            </div>
        </section>
