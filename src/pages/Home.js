        ...
        <section className="text-white px-24 container py-12 bg-hero-pattern bg-cover">
            <div>
                <div className="flex gap-x-16">
                    ...
                    <div className="relative last:after:hidden after:absolute after:top-8 after:bottom-1 after:start-3.5 after:w-[2px] after:-translate-x-[0.5px] after:bg-neutral-200">
                ...
                <div className="flex gap-x-16">
                    ...
                    <div className="relative last:after:hidden after:absolute after:top-9 after:bottom-1 after:start-3.5 after:w-[2px] after:-translate-x-[0.5px] after:bg-neutral-200">
                        <div className="relative z-10 size-7 flex justify-center items-center">
